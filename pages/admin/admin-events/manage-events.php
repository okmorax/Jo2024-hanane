...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT id_epreuve, nom_epreuve, DATE_FORMAT(date_epreuve, '%d/%m/%Y') AS date_epreuve_format, DATE_FORMAT(heure_epreuve,'%H:%i') AS heure_epreuve_format, nom_lieu, ville_lieu
            FROM EPREUVE 

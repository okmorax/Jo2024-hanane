...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Vérifiez si les champs essentiels sont vides
    if (empty($nomUtilisateur) || empty($prenomUtilisateur)) {
        $_SESSION['error'] = "Le Nom et le Prénom sont obligatoires.";
    ...
    try {
        ...
        $query = "UPDATE UTILISATEUR SET nom_utilisateur = :nomUtilisateur, prenom_utilisateur = :prenomUtilisateur WHERE id_utilisateur = :idUtilisateur";
...
try {
    $queryUtilisateur = "SELECT nom_utilisateur, prenom_utilisateur FROM UTILISATEUR WHERE id_utilisateur = :idUtilisateur";
...
<body>
    ...
    <main>
        ...
        ?>
        <form action="modify-users.php?id_utilisateur=<?php echo $id_utilisateur; ?>" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir modifier cet utilisateur?')">

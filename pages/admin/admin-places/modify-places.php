...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $codePostalLieu = filter_input(INPUT_POST, 'codePostalLieu', FILTER_SANITIZE_STRING);

    // Vérifiez si les champs essentiels sont vides
    if (empty($nomLieu) || empty($adresseLieu) || empty($villeLieu) || empty($codePostalLieu)) {
    ...
    try {
        ...
        $statement->bindParam(":codePostalLieu", $codePostalLieu, PDO::PARAM_STR);
...
<body>
    ...
    <main>
        ...
        ?>
        <form action="modify-places.php?id_lieu=<?php echo $id_lieu; ?>" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir modifier ce lieu?')">
            ...
            <label for="codePostalLieu">Code postal du lieu :</label>

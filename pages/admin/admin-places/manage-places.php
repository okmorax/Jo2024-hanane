...
<body>
    ...
    <main>
        ...
        try {
            ...
            $query = "SELECT * FROM LIEU ORDER BY nom_lieu, adresse_lieu, cp_lieu, ville_lieu";
    ...
    <script>
         function openAddPlacesForm() {
            // Rediriger vers la page d'ajout de lieu
            window.location.href = 'add-places.php';
        }

        function openModifyPlacesForm(id_lieu) {
        // Rediriger vers la page de modification avec l'ID du lieu
        window.location.href = 'modify-places.php?id_lieu=' + id_lieu;
    }
        function deletePlacesConfirmation(id_lieu) {
        // Afficher une fenêtre de confirmation pour supprimer un lieu
        if (confirm("Êtes-vous sûr de vouloir supprimer ce lieu?")) {
            // Rediriger vers la page de suppression avec l'ID du lieu
